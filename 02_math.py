...
sub = a - b
mul = a * b
div = a / b #get error with division by zero when make b = 0
...
print(math.e, math.ceil(math.e)) #math.ceil rounds up
print(math.inf, math.nan) #math.inf is infinity, math.nan is not a number
