...
for i in range(length):
	r = random.randint(1, 4) # generate a random number from 1 to 4
	if   r == 1: print('A', end='')
	elif r == 2: print('C', end='') #runs when if false
	elif r == 3: print('G', end='')
	else:        print('T', end='') #else is run when both if and elif false
print()
...
for i in range(len(dna)):
	...
	else: print('not W at',i)


# Let's print all the positions with a CG di-nucleotide
# Note the use of 'and'
# Why is there a -1 in the code below? because looking for pairs
